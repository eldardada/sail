...
if (pay) {
  ...
  payDataProducts.addEventListener('input', function (e) {
    var target = e.target;
    target.value = target.value.replace(/\D/g, '');
  });
  payDataProducts.addEventListener('change', function (e) {
    var target = e.target;
    if (target.value === '') target.value = 0;else if (target.value > 50) target.value = 50;
  });
...
var someVideo = document.querySelector('.video');
